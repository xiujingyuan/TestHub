...
public class RepayerBean {
    ...
    public static RepayerBean getDefaultRepayBean() {
        RepayerBean repayer = new RepayerBean();

        repayer.setIndividualName("李静");
        repayer.setIndividualIdnum("371322199012191765");
        repayer.setIndividualGender("f");
        repayer.setIndividualResidence("山东省临沂市罗庄区罗庄办事处沈泉庄村B区2号楼1001室");
        repayer.setIndividualWorkplace("山东省临沂市罗庄区韦姜屯康桥丽都宝莱饭店东临专业减肥店");
        repayer.setIndividualPermanent("山东省临沂市罗庄区罗庄办事处");
        repayer.setIndividualCompany("瘦典专业减肥店");
        repayer.setIndividualTel("14768340456");
        repayer.setIndividualWorkTel("0539-2411966");
        repayer.setIndividualResidenceTel("15255535671");
        repayer.setIndividualMateName("章伞");
        repayer.setIndividualMateTel("18909201111");
        repayer.setIndividualRelativeName("翟宝献");
        repayer.setIndividualRelativeRelation("4");
        repayer.setIndividualRelativeTel("13792999065");
        repayer.setIndividualWorkmateName("李有为");
        repayer.setIndividualWorkmateTel("18354440345");
        repayer.setIndividualRemark("test1");
        repayer.setIndividualNation("汉");
        repayer.setIndividualEmail("14768340456@139.com");
